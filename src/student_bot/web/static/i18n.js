...
(() => {
  ...
  const T = {
    sv: {
      ...
      "notice.body": " Boten svarar utifrån KTH:s officiella styrdokument och FAQ, men kan ändå ha fel – öppna källorna när det gäller något viktigt.",
      "notice.model.local": " Svaren genereras av en öppen språkmodell som körs på KTH:s egen utrustning.",
      "notice.feedback": " Använd gärna 👍 eller 👎 på svaren – feedback hjälper oss att förbättra botens funktioner och anpassa dess kunskapsbas.",
      ...
      "perf.server": "Den här servern",
      "perf.model": "Språkmodellen",
      "perf.toggle.label": "Visa resursanvändning",
      "perf.toggle.tip": "Visar hur lång tid varje steg tog och hur hårt servern arbetar. Valet sparas i din webbläsare.",
      "perf.tip.context": "Uppskattad tokenanvändning i promptkontexten jämfört med modellens context window (num_ctx).",
      "perf.tip.server": "Servern som kör den här webbplatsen. Den sköter sökningen i dokumenten och omrankningen av träffar — inte själva textgenereringen.",
      "perf.tip.model": "Språkmodellen körs på en separat maskin. TTFT = tid till första ordet, tok/s = ungefär antal tokens per sekund.",
      "perf.stage.search": "sökning",
      "perf.stage.rank": "omrankning",
      "perf.stage.total": "totalt",
    ...
    en: {
      ...
      "notice.body": " The bot answers from KTH's official policy documents and FAQs, but it can still be wrong — open the sources when it matters.",
      "notice.model.local": " Answers are generated by an open language model running on KTH's own hardware.",
      "notice.feedback": " Please use 👍 or 👎 on the answers — feedback helps us improve what the bot can do and shape its knowledge base.",
      ...
      "perf.server": "This server",
      "perf.model": "The language model",
      "perf.toggle.label": "Show resource usage",
      "perf.toggle.tip": "Shows how long each step took and how hard the server is working. Remembered in this browser.",
      "perf.tip.context": "Estimated prompt-context token usage versus model context window (num_ctx).",
      "perf.tip.server": "The server running this site. It does the document search and the reranking — not the text generation.",
      "perf.tip.model": "The language model runs on a separate machine. TTFT = time to first token, tok/s = approximate tokens per second.",
      "perf.stage.search": "search",
      "perf.stage.rank": "rerank",
      "perf.stage.total": "total",
